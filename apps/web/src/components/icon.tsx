...
/** An icon as plain data: its shapes on a 24px grid, and whether it is a filled brand mark. */
...
/**
 * One line style everywhere: Rune Icons' base set wherever Rune draws the
 * icon, Lucide otherwise, both on a 24px grid at 16px with a round 2px stroke
 * in currentColor, so an icon takes the colour of the text or kind around it.
