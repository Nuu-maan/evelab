/** eve's wordmark, as eve.dev draws it, for crediting the framework EveLab builds on. */
export function EveLogo({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 169 53" role="img" aria-label="eve" fill="currentColor">
